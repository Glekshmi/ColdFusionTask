            ...
            <cfelse>
                    <thead>
                        <tr>
                            ...
                            <th colspan="3" class="tableHeader">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <cfloop query="#local.display#">
                            <tr>
                                ...
                                <td>#pageName#</td>
                                <td>#Description#</td>
                                <td colspan="3"><a href="editPage.cfm?idPage=#pageId#"><span class="material-symbols-outlined">edit</span></a>
                                <a href="controls/pages.cfc?method=deleteRow&idPage=#pageId#"><span class="material-symbols-outlined">
                                    delete
                                    </span></a></td>
